<template>
  <div>
      ...
      <v-card-subtitle class="font-roboto">
        Give us your statement and describe why you're creating this poll. </v-card-subtitle>
      <v-container class="">
        <v-row>
          <v-col sm="12">
            <v-text-field
          ...
          <v-col sm="12">
            <v-text-field
              name="AddedValueField"
              v-model="addedValue"
              :rules="addedValueRules"
              counter
              maxlength="100"
              hint="What is the added value of this poll"
              label="Added value"
            ></v-text-field>
          </v-col>
          <v-col sm="12">
...
export default {
  ...
  data () {
    return {
      statement: '',
      addedValue: '',
      statementRules: [v => v.length <= 50 || 'Max 50 characters'],
